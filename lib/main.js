...
// Wrapper for validateURL while we deprecate
// TODO: remove when done
main.validateID = link => main.validateURL(link, true);
// Mostly equal to main.getPlaylistID
const URL = require('url');
main.validateURL = (link, noWarn = false) => {
  // TODO: remove when done
  if (main.do_warn_deprecate && !noWarn) {
    console.warn(
      `/*****************************************************************************************************

...
const getPlaylist = module.exports = (linkOrId, optionsOrCallback, callback) => { // eslint-disable-line consistent-return, max-len
  ...
  if (typeof optionsOrCallback === 'function') {
    ...
    optionsOrCallback = { limit: 100, headers: {
  ...
  } else if (!optionsOrCallback.headers.hasOwnProperty('x-youtube-client-name')) {
    optionsOrCallback.headers['x-youtube-client-name'] = DEFAULT_X_YOUTUBE_CLIENT_NAME;
  } else if (!optionsOrCallback.headers.hasOwnProperty('x-youtube-client-version')) {
    optionsOrCallback.headers['x-youtube-client-version'] = DEFAULT_X_YOUTUBE_CLIENT_VERSION;
  }

...
var ignorable_errors = [
	'Try out a fresh look for YouTube. <a href="/new">Learn more</a>.'
];

exports.get_firstpage = function(playlist_id, options, callback) {
	var request = https.get('https://www.youtube.com/playlist?list=' + playlist_id + '&hl=en', function(resp) {
		if(resp.statusCode != 200) {
			if(resp.statusCode === 303) return callback(new Error('video not avaible'));

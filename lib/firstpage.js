...
module.exports = (playlistID, options, callback) => {
  const request = HTTPS.get({ host: 'www.youtube.com', path: `/playlist?list=${playlistID}&hl=en&disable_polymer=true`, headers: { 'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.117 Safari/537.36' } }, resp => { // eslint-disable-line consistent-return, max-len
